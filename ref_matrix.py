...
def reference_matrix_from_signatures(signatures, corr_thresh=None, max_thresh=5, mut_thresh=0.05, out_prefix='',
                                     N=None):
    if N is not None:
...
if __name__ == "__main__":
    ...
    reference_matrix_from_file(args.ref_file, corr_thresh=args.corr_thresh, max_thresh=args.max_thresh,
                               mut_thresh=args.mut_thresh, out_prefix=args.out_prefix, N=args.N)
