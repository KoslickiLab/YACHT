#!/usr/bin/env python
"""
Estimate the abundance of microorganisms from a reference database matrix and metagenomic sample.

Usage:
    python script.py --json <json_file_path> --sample_file <sample_file_path> --outdir <output_directory>

Parameters:
    --json (str): Path to a JSON file generated by make_training_data_from_sketches.py.
    --sample_file (str): Metagenomic sample in .sig format.
    --significance (float): Minimum probability of individual true negative (default: 0.99).
    --keep_raw (bool): Keep raw results in the output file.
    --show_all (bool): Show all organisms in the output file, regardless of presence.
    --min_coverage (float): Minimum coverage to compute false negative weight (default: [1, 0.5, 0.1, 0.05, 0.01]).
    --out_filename (str): Output filename (default: 'result.xlsx').
