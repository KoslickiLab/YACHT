...
python ../../recover_abundance.py --ref_file default_EU_ref_matrix_processed.npz  --ksize 31 --sample_file simulated_mg.fq.sig --outfile EU_results_default.csv --min_coverage 0.5
...
python ../calculate_binary_stats.py -d .
