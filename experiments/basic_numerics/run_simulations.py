...
def write_args(filename, args):
    with open(filename, 'w', newline='', encoding='utf-8') as f:
        writer = csv.writer(f)
        header =['num_sims','ksize','num_kmers','num_genomes','s_known','s_unknown','mut_thresh','relation_thresh','p_val','min_coverage','mut_range','abundance_range','seed']
        writer.writerow(header)
        writer.writerow([args.num_sims, args.ksize, args.num_kmers, args.num_genomes, args.s_known, args.s_unknown, args.mut_thresh, args.relation_thresh, args.p_val, args.min_coverage, args.mut_range, args.abundance_range, args.seed])
