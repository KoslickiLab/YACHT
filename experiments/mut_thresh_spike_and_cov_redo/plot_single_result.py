...
parser.add_argument('-sc', '--spike_coverage', type=float, required=True, help='Actual coverage of the spike in the sample.')
parser.add_argument('-ct', '--coverage_threshold', type=float, required=True, help='Coverage threshold used to call a genome present.')
parser.add_argument('-mt', '--mutation_threshold', type=float, required=True, help='Mutation threshold used to call a genome present.')
args = parser.parse_args()
results_file = args.results_file
spike_coverage = args.spike_coverage
...
ANI_thresh = 1 - mutation_threshold
