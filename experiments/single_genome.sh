...
python one_genome_sample.py --out_dir one_genome_sample --bucket_number 0 --pair_number 0
cd ${simsFolder}
...
python ../../recover_abundance.py --ref_file default_EU_ref_matrix_processed.npz  --ksize 31 --sample_file simulated_mg.fq.sig --outfile EU_results_default.csv --mut_thresh 0.05
